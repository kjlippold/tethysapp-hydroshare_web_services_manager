...
# from ..app import HydroshareWebServicesManager
    ...
    4. Enter tethys test command.
       ...
       See below for specific examples
        ...
        To run all tests across this app:
            Test command: "tethys test -f tethys_apps.tethysapp.hydroshare_web_services_manager"

        To run all tests in this file:
            Test command: "tethys test -f tethys_apps.tethysapp.hydroshare_web_services_manager.tests.tests"

        To run tests in the HydroshareWebServicesManagerTestCase class:
            Test command: "tethys test -f tethys_apps.tethysapp.hydroshare_web_services_manager.tests.tests.HydroshareWebServicesManagerTestCase"

        To run only the test_if_tethys_platform_is_great function in the HydroshareWebServicesManagerTestCase class:
            Test command: "tethys test -f tethys_apps.tethysapp.hydroshare_web_services_manager.tests.tests.HydroshareWebServicesManagerTestCase.test_if_tethys_platform_is_great"
...
class HydroshareWebServicesManagerTestCase(TethysTestCase):
    """
    ...
    def set_up(self):
        ...
        test database creation function here, like so:
            ...
            self.create_test_persistent_stores_for_app(HydroshareWebServicesManager)
    ...
    def tear_down(self):
        ...
        stores, you should call the test database destruction function from here, like so:
            ...
            self.destroy_test_persistent_stores_for_app(HydroshareWebServicesManager)
    ...
    def test_home_controller(self):
        ...
        response = c.get('/apps/hydroshare-web-services-manager/')  # The final '/' is essential for all pages/controllers
